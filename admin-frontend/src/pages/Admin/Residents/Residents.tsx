...
export default function Residents() {
    ...
    const fetchResidents = async () => {
        ...
        try {
            ...
            const res = await fetch(`${import.meta.env.VITE_API_URL}/admin/users?role=residents`, {
    ...
    return (
        <>
            <PageMeta title="Manage Residents | Admin" description="Active or Deactivate Residents" />
            <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 ${loading ? 'opacity-50 pointer-events-none' : ''}`}>
                <h2 className="text-xl font-bold mb-4 dark:text-white">Resident Management</h2>
